...
<head>
    ...
    <style>
        ...
        .register-container { max-width: 350px; margin: 80px auto; background: #fff; border-radius: 8px; box-shadow: 0 2px 18px #0001; padding: 32px; }
        ...
        .login-link { display: block; text-align: center; margin-top: 18px; color: #617dc2; }
    </style>
</head>
<body>
